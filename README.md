...
| <a name="input_awp_centralized_cloud_account_id"></a> [awp_centralized_cloud_account_id] | The Id of the central AWS account where the scans take place  | `string` | n/a | in case of inAccountSub scan mode |
