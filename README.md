...
This Terraform module is designed to enable AWP (Agentless Workload Posture) on AWS account.
...
| <a name="requirement_dome9"></a> [dome9](#requirement\_dome9) | >=1.40.2 |
...
| <a name="input_scan_aws_licensed_images"></a> [scan_aws_licensed_images](#input\_scan\_aws\_licensed\_images) |  Scan AWS licensed images | `bool` | `false` | `true` or `false` | no |
...
| [aws_iam_policy.CloudGuardAWPCrossAccountRolePolicySub](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| [aws_lambda_invocation.CloudGuardAWPSnapshotsUtilsCleanupFunctionInvocation_inAccountHub](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_invocation) | resource |
